...
- **netlist generation**: after it error checks the code it generate the initial netlist (netlist is a textual description of the electronic circuit connectivity)
